...
| cabinet                    | n.m. 诊所；小房间                                       |
| médical                    | adj. 医疗的，医学的                                     |
| mauvais, e                 | adj. 坏的<br>adv. 不好                                  |
| difficulté                 | n.f. 困难                                               |
| fièvre                     | n.f. 发烧                                               |
| mal                        | adj. 坏的<br>adv. 坏，不好<br>n.m. 坏，不好；损害；困难 |
| avoir mal à                | （身体的某个部位）疼痛                                  |
| tête                       | n.f. 脑袋                                               |
| aussitôt                   | adv. 立即，立刻                                         |
| chéri, e                   | adj. 亲爱的<br>n. 亲爱的人                              |
| matinée                    | n.f. 上午                                               |
| température                | n.f. 温度                                               |
| lit                        | n.m. 床                                                 |
| thermomètre                | n.m. 温度计                                             |
...
| baisser                    | v.t. 降下；减低<br>v.i. 减低，减弱                      |
| rapidement                 | adv. 迅速地                                             |
| retourner                  | v.i. 返回                                               |
| reposer                    | v.t. 再放回                                             |
| se reposer                 | v.pr. 休息                                              |
...
| guérir                     | v.t. 治愈，使健康<br>v.i. 治愈，康复                    |
| se guérir                  | v.pr. 痊愈，恢复健康                                    |
| par                        | prép. 每；经过；从                                      |
| avant                      | prép. 在……之前<br>adv. 之前                             |
| oublier                    | v.t. 忘记                                               |
| sport                      | n.m. 体育运动                                           |
...
3. 最近将来时：aller + 不定式
4. 最近将来时比较好理解，我们也见过好几次了。表示即将发生的动作。和英语 `be going to` 一样。
5. 最近过去时比较不一样。venir 的本意是”来“，venir de 就有 `come from` 的意思。这里形象地表示不久前刚发生或完成的动作 `just+过去式`。如：
...
6. 这篇文章基本是用过去时。最近过去时的句子会用横线划出。注意复合过去时哦。
...
==difficulté=={.danger} n.f. 困难

==fièvre=={.danger} n.f. 发烧

==avoir de la fièvre=={.danger} 发烧

==mal=={.danger} adj. 坏的 n. 损坏，疼痛，困难

==avoir mal à=={.danger} （身体的某个部位）疼痛

==tête=={.danger} n.f. 脑袋

==… il avait de la fièvre et très mal à la tête.=={.danger}
...
==thermomètre=={.danger} n.m. 温度计

==grippe=={.danger} n.f. 流行性感冒

==pris=={.danger} 是 prendre 的过去分词

==Il s'est demandé s'il avait la grippe.=={.danger}
...
- 这里 si 后面用的是未完成过去时，表示过去一个持续的动作，目前还没学。avait 是 avoir 的未完成过去时变位。
...
==docteur=={.danger} n.m. 医生，大夫；博士

==examiner=={.danger} v.t. 检查；审查

==langue=={.danger} n.f. 舌头；语言

==bouche=={.danger} n.f. 嘴，口

==gorge=={.danger} n.f. 嗓子

==écouter=={.danger} v.t. 听 `listen`

==poumon=={.danger} n.m. 肺

==poitrine=={.danger} n.f. 胸部，胸脯

==dos=={.danger} n.m. 背部，背

==il lui a regardé la langue=={.danger}
...
==violent, e=={.danger} adj. 强烈的；猛烈的

==fièvre=={.danger} n.f. 发烧

==baisser=={.danger} v.t. 降下；减低

==rapidement=={.danger} adv. 迅速地

==faire baisser=={.danger}
...
==retourner=={.danger} v.i. 返回

==retourner au travail=={.danger} `return to work`

> « Quel courage, cher ami ! Pour le moment, il faut **vous reposer**. »
>
> “您真勇敢，亲爱的朋友！现在，您需要好好休息。”

==reposer=={.danger} v.t. 再放回

==se reposer=={.danger} v.pr. 休息

==il faut vous reposer=={.danger}
...
==asseoir=={.danger} v.t. 让……坐下

==s'asseoir=={.danger} v.pr. 坐，坐下

==s'est assis=={.danger} 同样是代动词的复合过去时。用 être 作助动词。（p177）
...
==oreille=={.danger} n.f. 耳，耳朵

> « Au **ventre** ? Non ? Vous n'avez pas mal aux **yeux** ? Bien, ce n'est pas grave. Vous avez **seulement** une grippe. Je vais vous faire une **ordonnance**. »
>
> “肚子呢？没有疼吗？你的眼睛也不疼吧？好的，这并不严重。你只是得了流感。我会给您开个处方。”

==ventre=={.danger} n.m. 肚子，腹

==œil (pl. yeux)=={.danger} n.m. 眼睛

==seulement=={.danger} adv. 只，仅仅，才
...
==trop=={.danger} adv. 太，过于

==médicament=={.danger} n.m. 药物，药剂

> « Il en faut **quelques-uns**, si vous voulez **vous guérir** vite. »
>
> “如果你想快点恢复，需要一些药物。”
>
> _”You need a few, if you want to heal yourself quickly.”_

==quelqu'un, e=={.danger} pron.indéf. 某一个；某人

==quelques-uns, quelques-unes=={.danger} pl. 某一些；某些人

==guérir=={.danger} v.t. 治愈，使健康 v.i. 治愈，康复

==se guérir=={.danger} v.pr. 痊愈，恢复健康

==Il en faut quelques-uns=={.danger}
...
==par=={.danger} prép. 每；经过；从

==avant=={.danger} prép. 在……之前

==par + nom=={.danger} 表示“每...”。`a day / per day / daily`

==Prenez-les=={.danger} 中的 les 是直接宾语人称代词。由于不放在命令式句首，就用连字符放动词后面。

> Vous allez bien dormir ce soir ! Et **n'oubliez** pas de faire du **sport** dès que vous serez guéri ! »

==oublier=={.danger} v.t. 忘记

==sport=={.danger} n.m. 体育运动

==serez=={.danger} 是 être 的直陈式 简单将来时变位。

==dès que + 从句=={.danger}

表示“一旦…（就…）” `as soon as`。如：Dès qu'il fait beau, nous allons faire une promenade au jardin. 天一晴，我们就去花园里散步。

==faire du sport=={.danger} 做体育运动
