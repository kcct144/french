...
1. 之后非易错发音不再标注音标，大家要加强拼读训练
2. 动词变位大家要自己背、自己查。之后也不再赘述
...
==présente=={.danger} [prezɑ̃]  第一组动词变位（er 结尾）
...
- 男生说时用 ==Enchanté=={.danger}
- 女生说时用 ==Enchantée=={.danger}
...
==aimer=={.danger} v.  喜欢，愿意 \_(like`

==Elle a six ans.=={.danger}
