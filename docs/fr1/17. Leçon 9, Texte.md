...
==a fait 是复合过去时变位
==aussi 是副词 3. 注意 promenades 是名词，被 belles 修饰，被不定冠词 des（由于后面接形容词，变为了 de）限定。 4. faire des promenades 散步 `take walks`，也可以写为 faire une promenade `take a walk` 5. le long de... 相当于一个介词 `along`
...
==**acheter** v.t. 购买
==**plusieurs** a.indéf.pl. 几个，好几个 3. **bouquiniste** n. 旧书商 4. **lire** v.t. 阅读，朗读 \_(read`
...
==dans quelques jours `in a few days` 几天后/内
...
> 明天我们就要去阿维尼翁了。
>
> `We are leaving for Avignon tomorrow\_.)
